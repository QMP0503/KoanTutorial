...
class AboutClasses < Neo::Koan
  ...
  def test_you_can_rip_the_value_out_using_instance_eval
    ...
    assert_equal 'Fido', fido.instance_eval('@name', __FILE__, __LINE__)
    # string version, this helps show error and location if this fail
  ...
  def test_args_to_new_must_match_initialize
    ...
    # THINK ABOUT IT:
    # Why is this so?
    # It's missing a argument when creating a new object
  end
  ...
  def test_all_objects_support_to_s_and_inspect
    ...
    assert_equal String.to_s.upcase, 'STRING'
