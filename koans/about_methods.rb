...
class AboutMethods < Neo::Koan
  ...
  def method_with_defaults(a, b=:default_value)
    [a, b] #if b is not assigned it will be the :deafault_value symbol
  end
  ...
  def method_with_var_args(*args) #*args collects all arguments into an array
    args
  end

  def test_calling_with_variable_arguments
    assert_equal Array, method_with_var_args.class #This is calling the method and getting the class of the return value
  ...
  #So, methods implicitly return the last line, will EXPLICITLY return a value with the word return
  ...
  def test_calling_methods_in_same_class_with_explicit_receiver
    assert_equal 12 , self.my_method_in_the_same_class(3,4) #refers to the current object
  end
